...
extern void ADC1SS2Handler(void);
...
void (* const g_pfnVectors[])(void) =
{
    ...
    GPIOPortAIntHandler,                      // GPIO Port A  IQN - 0
    ...
    ADC0SS3Handler    ,                     // ADC Sequence 3   - IRQ Number: 17
    IntDefaultHandler,                      // Watchdog timer
    IntDefaultHandler ,                        // Timer 0 subtimer A - IRQ Number: 19
    ...
    IntDefaultHandler,                        // ADC1 Sequence 3   - Number 51
    0,                                      // Reserved
    0,                                      // Reserved
